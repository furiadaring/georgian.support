...
export const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Страховка покрывает экстренную медицинскую помощь, госпитализацию, амбулаторное лечение, лекарства по рецепту, экстренную стоматологию и репатриацию. Максимальное покрытие составляет 30,000 GEL.",
      },
    },
    {
      "@type": "Question",
