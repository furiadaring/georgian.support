  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <main className="main-content w-full flex flex-col items-center">
        {/* Hero Section */}
        <section className="relative w-full bg-linear-to-br from-orange-500 via-amber-500 to-orange-600 overflow-hidden" style={{ paddingTop: '120px', paddingBottom: '80px' }}>
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute top-20 left-[10%] w-72 h-72 bg-white/10 rounded-full blur-3xl" />
            <div className="absolute top-40 right-[15%] w-96 h-96 bg-yellow-300/10 rounded-full blur-3xl" />
          ...
          <div className="relative z-10" style={{ maxWidth: '1152px', marginLeft: 'auto', marginRight: 'auto', paddingLeft: '1rem', paddingRight: '1rem' }}>
            <div className="text-center flex flex-col items-center">
              ...
              <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-white text-center" style={{ marginBottom: '1.5rem' }}>
                {t?.title || "Автострахование"} <span className="text-yellow-200">{t?.titleHighlight || "ОСАГО"}</span>
              </h1>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link
                  ...
                  className="inline-flex items-center gap-2 bg-white text-orange-600 py-3 px-8 rounded-full font-semibold hover:bg-orange-50 transition-all duration-200 shadow-lg"
                >
          ...
          <div style={{ maxWidth: '1152px', marginLeft: 'auto', marginRight: 'auto', paddingLeft: '1rem', paddingRight: '1rem' }}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-orange-100 rounded-2xl flex items-center justify-center mx-auto" style={{ marginBottom: '16px' }}>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {PRICING.map((vehicle, index) => (
                      <tr key={vehicle.id} className={`border-b border-gray-100 hover:bg-gray-50 ${vehicle.highlight ? 'bg-orange-50/50' : ''}`}>
                        <td className="p-4">
                        ...
                        {vehicle.prices.map((price, i) => (
                          <td key={i} className={`text-center p-4 font-semibold ${vehicle.highlight ? 'text-orange-600' : 'text-primary-black'}`}>
                            {price} ₾
                          </td>
                        ))}
                      </tr>
        ...
        {/* Contact Section */}
        <section className="w-full bg-linear-to-br from-orange-500 via-amber-500 to-orange-600 py-16 lg:py-24">
          <div style={{ maxWidth: '900px', marginLeft: 'auto', marginRight: 'auto', paddingLeft: '1rem', paddingRight: '1rem' }}>
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4" style={{ marginBottom: '3rem' }}>
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-3 bg-white text-orange-600 py-4 px-8 rounded-2xl font-semibold hover:bg-orange-50 transition-all duration-200 shadow-lg"
                >
